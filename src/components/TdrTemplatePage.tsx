  ...
  // ═══════════════════════════════════════════════════════════════════════════════
  // 🏗️ INITIAL TEMPLATE DATA — Todo el HTML de las tablas vive aquí.
  // Fiel al formato oficial MINEDU (PDF de referencia).
  // Celdas con contenteditable="false" = variables protegidas (no editables por Admin).
  // ═══════════════════════════════════════════════════════════════════════════════
  export const initialTemplateData: Record<string, { aplica: boolean; html: string }> = {
    ...
    // Sección 1 — Cabecera + Denominación
    tdr_denominacion: {
      aplica: true,
      html: `<table class="excel-table">
    <tbody>
      <tr>
        <td class="ehl" colspan="2">DENOMINACIÓN DE LA CONTRATACIÓN</td>
      </tr>
      <tr>
        <td colspan="2" class="dd fb tc" contenteditable="false">{{DENOMINACION}}</td>
      </tr>
    </tbody>
  </table>`,
    },
    ...
    <tbody>
      <tr>
        <td class="ehl" colspan="2">DESCRIPCIÓN DEL SERVICIO (OBJETIVO DE LA CONTRATACIÓN)</td>
      </tr>
      <tr>
        <td colspan="2" class="dd" contenteditable="false" style="padding:8px 10px; text-align:justify;">{{DESCRIPCION_SERVICIO}}</td>
      </tr>
    </tbody>
  </table>`,
    },

    // Sección 2 — Finalidad Pública (OEI + AEI editables por Admin)
    tdr_finalidad: {
      aplica: true,
      html: `<table class="excel-table">
    <tbody>
      <tr>
        <td class="ehl" colspan="2">FINALIDAD PÚBLICA</td>
      </tr>
      <tr>
        <td colspan="2" style="padding:8px 10px; text-align:justify; line-height:1.5;">
  ...
  export const SECCIONES_MAESTRAS: Array<{
  ...
  }> = [
    {
      ...
      items: [
        { id: 'tdr_denominacion', label: '① Denominación de la Contratación' },
        { id: 'tdr_descripcion', label: '① Descripción del Servicio (Objetivo)' },
        { id: 'tdr_finalidad', label: '② Finalidad Pública (OEI / AEI)' },
